...
import { ApiError } from '$lib/apis/core/ApiError';
import type { ApiRequestOptions } from '$lib/apis/core/ApiRequestOptions';
import type { ApiResult } from '$lib/apis/core/ApiResult';
import { CancelablePromise } from '$lib/apis/core/CancelablePromise';
import type { OnCancel } from '$lib/apis/core/CancelablePromise';
import type { OpenAPIConfig } from '$lib/apis/core/OpenAPI';

axios.defaults.baseURL = `${ String(import.meta.env.backend_endpoint || '') }`;
...
axios.interceptors.response.use(
  res => {
    const body = res?.data;
    if (has(body, 'data') && has(body, 'errors')) {
